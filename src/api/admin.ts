...
let prefix = ""
//部门
export const listDepartment = <T>(data: T) => requests(`${prefix}/department/list`, data, 'post', false)
...
//角色
export const listRole = <T>(data: T) => requests(`${prefix}/role/list`, data, 'post', false)
...
//设备列表
export const deviceList = <T>(data: T) => requests(`/device/list`, data, 'post', false)
...
//设备列表账户
export const listDeviceAccount = <T>(data: T) => requests(`/device/listDeviceAccount`, data, 'post', false)
...
//设备账号模块
export const accountList = <T>(data: T) => requests(`/account/list`, data, 'post', false)
...
//用户
export const listUser = <T>(data: T) => requests('/user/list', data, 'post', false)
...
//上传
export const fileUpload = <T>(data: T, headers:Object) => requests('/file/upload', data, 'post', true, headers)
//下载
